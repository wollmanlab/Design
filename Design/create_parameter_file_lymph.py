...
user_parameters['input'] = '/u/home/z/zeh/rwollman/data/Mouse_Lymph/Mouse_LN_Datasets/Training_data/'
...
parameter_variant_list.append(
    {
    'fig':['Lymph Bit Number'],
    'decoder_n_lyr':[0,1],
    'n_bit':[3,6,9,12,15,18,21,24],
    'n_probes':[50000],
    'replicate':[1,2,3],
    })

# conda activate designer_3.12 ; python '/u/home/z/zeh/rwollman/zeh/Repos/Design/Design/create_parameter_file_lymph.py' 
